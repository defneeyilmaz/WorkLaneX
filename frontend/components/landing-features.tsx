import { Calendar, FileText, Kanban, LayoutDashboard, MessageSquare, Sparkles } from "lucide-react";
...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Share quick updates and questions in a project feed with live refresh.",
  },
  {
    icon: Sparkles,
    title: "AI subtasks",
